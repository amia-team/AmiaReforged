...
public static class EpicCompanionAppearance
{
    ...
    public static bool ApplyEpicCompanionAppearance(NwCreature associate, AssociateType associateType, NwCreature owner, NwItem? pcKey)
    {
        ...
        {
            AnimalCompanionCreatureType.Badger => new CompanionAppearanceData(WyvernDescription, WyvernAppearance, WyvernPortrait),
            AnimalCompanionCreatureType.Wolf => new CompanionAppearanceData(DisplacerBeastDescription, DisplacerBeastAppearance, DisplacerBeastPortrait),
            AnimalCompanionCreatureType.Bear => new CompanionAppearanceData(DireBearDescription, DireBearAppearance, DireBearPortrait),
            AnimalCompanionCreatureType.Boar => new CompanionAppearanceData(RaptorDescription, RaptorAppearance, RaptorPortrait),
            AnimalCompanionCreatureType.Hawk => new CompanionAppearanceData(GiantEagleDescription, GiantEagleAppearance, GiantEaglePortrait),
            AnimalCompanionCreatureType.Panther => new CompanionAppearanceData(MaleLionDescription, MaleLionAppearance, MaleLionPortrait),
            AnimalCompanionCreatureType.Spider => new CompanionAppearanceData(GiantSpiderDescription, GiantSpiderAppearance, GiantSpiderPortrait),
            AnimalCompanionCreatureType.DireWolf => new CompanionAppearanceData(GuardianWolfDescription, GuardianWolfAppearance, GuardianWolfPortrait),
            AnimalCompanionCreatureType.DireRat => new CompanionAppearanceData(GiantScorpionDescription, GiantScorpionAppearance, GiantScorpionPortrait),
        ...
        associate.PortraitResRef = appearanceData.Portrait;
