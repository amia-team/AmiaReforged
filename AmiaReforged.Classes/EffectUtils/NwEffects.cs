...
{    
    ...
    public static bool IsValidSpellTarget(uint  target, int  targetType, uint caster)
    {
        ...
        switch (targetType)
        {
            ...
            case SpellTargetStandardhostile:
            {
                ...
                {
                    if (GetLocalInt(GetModule(), "X2_SWITCH_ENABLE_NPC_AOE_HURT_ALLIES") == 1)
                    {
        ...
        && GetLocalInt(GetModule(), "X2_SWITCH_ENABLE_NPC_AOE_HURT_ALLIES") == 0)
        {
            returnBool = false;
        }
    ...
    public static void SetCustomShape(uint  target, uint item, string subString, float duration)
    {
        ...
        SetLocalInt(item, "original_gender", gender);
        SetLocalInt(item, "original_pheno", appearance);
        SetLocalInt(item, "original_appearance", pheno);
        SetLocalInt(item, "original_soundset", soundset);
        SetLocalInt(item, "original_portrait", portrait);
        SetLocalInt(item, "original_tail", tail);
        SetLocalInt(item, "original_wings", wings);
        SetLocalInt(item, "original_rfoot", rFoot);
        SetLocalInt(item, "original_lfoot", lFoot);
        SetLocalInt(item, "original_rshin", rShin);
        SetLocalInt(item, "original_lshin", lShin);
        SetLocalInt(item, "original_rthigh", rThigh);
        SetLocalInt(item, "original_lthigh", lThigh);
        SetLocalInt(item, "original_pelvis", pelvis);
        SetLocalInt(item, "original_torso", torso);
        SetLocalInt(item, "original_belt", belt);
        SetLocalInt(item, "original_neck", neck);
        SetLocalInt(item, "original_rfore", rFore);
        SetLocalInt(item, "original_lfore", lFore);
        SetLocalInt(item, "original_rbicep", rBicep);
        SetLocalInt(item, "original_lbicep", lBicep);
        SetLocalInt(item, "original_rshoulder", rShoulder);
        SetLocalInt(item, "original_lshoulder", lShoulder);
        SetLocalInt(item, "original_rhand", rHand);
        SetLocalInt(item, "original_lhand", lHand);
        SetLocalInt(item, "original_head", head);
        SetLocalInt(item, "original_colorhair", colorHair);
        SetLocalInt(item, "original_colorSkin", colorSkin);
        SetLocalInt(item, "original_colortattoo1", colorTattoo1);
        SetLocalInt(item, "original_colortattoo2", colorTattoo2);
        SetLocalFloat(item, "original_scale", scale);
        ...
        customShapeEffect = TagEffect(customShapeEffect, "customshape_effect");
