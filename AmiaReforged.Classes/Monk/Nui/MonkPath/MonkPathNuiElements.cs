...
public static class MonkPathNuiElements
{
    ...
    public const string CrashingMeteorAbilities =
        "Binding Strike: Deals 2d6 elemental damage in a large radius (reflex halves). Each Ki Focus adds +2d6 damage." +
    ...
    public const string EchoingValleyAbilities =
        "Binding Strike: Summons an Echo for 2 turns and causes existing Echoes to deal 1d6 sonic damage in a medium radius. Each Ki Focus allows one additional Echo." +
    ...
    public const string FloatingLeafAbilities =
        "Passive: Melee attacks use wisdom for attack rolls. Binding, Eagle, and Axiomatic Strike work with ranged weapons." +
        "\n\nBinding Strike: Bypasses mind immunity, causing a weaker effect. Ki Focus I pacifies, II dazes, and III stuns." +
    ...
    public const string SwingingCenserAbilities =
        "Binding Strike: Heals the monk and nearby allies for 1d6 in a medium radius. Each Ki Focus adds +1d6." +
