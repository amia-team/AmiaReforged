...
public class EpicWildMagic
{
    ...
    public void Earthquake(NwCreature monk, NwCreature target, int dc, byte monkLevel)
    {

    }

    public void Sunburst(NwCreature monk, NwCreature target, int dc, byte monkLevel)
    {

    }

    public void MeteorStorm(NwCreature monk, NwCreature target, int dc, byte monkLevel)
    {
