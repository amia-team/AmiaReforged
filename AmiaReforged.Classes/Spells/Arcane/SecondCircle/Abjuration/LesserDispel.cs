...
///
/// Dispel check: 1d20 + caster level (max +5) + 2 per Abjuration Focus vs DC 12 + spell's caster level.
///
/// Spell resistance: no.
...
public class LesserDispel(DispelService dispelService) : ISpell
{
    ...
    private void DispelArea(NwCreature caster, Location location, int dispelModifier, Effect impVfx, NwSpell spell)
    {
        ...
        location.ApplyEffect(EffectDuration.Instant, Effect.VisualEffect(VfxType.FnfLosNormal20));
