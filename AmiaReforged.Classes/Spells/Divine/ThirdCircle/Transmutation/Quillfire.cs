...
public class Quillfire : ISpell
{
    ...
    public void OnSpellImpact(SpellEvents.OnSpellCast eventData)
    {
        ...
        async Task FireQuills()
        {
            ...
            for (int i = 0; i < numberOfQuills; i++)
            {
                ...
                int quillDamage = CalculateDamage(eventData.MetaMagicFeat);
    ...
    private static int CalculateDamage(MetaMagic metaMagic)
    {
        int damageByQuill = SpellUtils.MaximizeSpell(metaMagic, 6, 4);
        damageByQuill = SpellUtils.EmpowerSpell(metaMagic, damageByQuill);
        
        return damageByQuill;
    }
