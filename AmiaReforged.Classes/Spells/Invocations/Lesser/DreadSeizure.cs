...
public class DreadSeizure
{
    public void CastDreadSeizure(uint nwnObjectId)
    {
        ...
        IntPtr aoe = EffectAreaOfEffect(AOE_MOB_CIRCEVIL, sOnEnterScript: "wlk_dreadenter", sHeartbeatScript: "****",
            sOnExitScript: "wlk_dreadexit");

        // Apply the VFX impact and effects.
        ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectVisualEffect(VFX_IMP_AURA_NEGATIVE_ENERGY), nwnObjectId,
            duration);
