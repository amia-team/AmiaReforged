...
public class BeshadowedEssence : IEssence
{
    ...
    (
        ...
        DoomVfx: AmiaVfxTypes.FnfDoomShadow,
        PulseVfx: AmiaVfxTypes.ImpPulseShadowChest,
        HideousBlowVfx: AmiaItemVisuals.Shadow,
