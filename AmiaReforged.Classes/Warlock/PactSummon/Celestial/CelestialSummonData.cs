...
namespace AmiaReforged.Classes.Warlock.PactSummon.Celestial;

public static class CelestialSummonData
{
    public static readonly PactSummonBaseData SummonData = new()
    {
        ...
        SharedEffect = Effect.LinkEffects(Effect.VisualEffect(VfxType.DurGhostSmoke2),
            Effect.VisualEffect(VfxType.DurLightWhite20))
    };
