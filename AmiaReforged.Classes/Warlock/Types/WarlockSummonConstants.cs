...
public static class WarlockSummonConstants
{
    ...
    /// </summary>
    public static readonly Effect AberrationEffects = Effect.LinkEffects(Effect.DamageIncrease(1, DamageType.Acid),
        Effect.Immunity(ImmunityType.MindSpells));
    ...
    public static readonly Effect UndeadImmunities = Effect.LinkEffects(Effect.Immunity(ImmunityType.SneakAttack),
        ...
        Effect.Immunity(ImmunityType.Death), Effect.Immunity(ImmunityType.NegativeLevel),
        Effect.Immunity(ImmunityType.AbilityDecrease));

    public static Effect CelestialEffects(int concealment) =>
        Effect.LinkEffects(Effect.VisualEffect(VfxType.DurGhostSmoke2), Effect.VisualEffect(VfxType.DurLightWhite20),
            Effect.Concealment(concealment),
            UndeadImmunities);

    public static Effect FeyEffects(int concealment) =>
        Effect.LinkEffects(Effect.VisualEffect(VfxType.DurAuraGreenLight), Effect.VisualEffect(VfxType.DurInvisibility),
            Effect.Concealment(concealment),
            UndeadImmunities);

    public static Effect SlaadEffects(int regen) =>
        Effect.LinkEffects(Effect.DamageResistance(DamageType.Acid, 5), Effect.DamageResistance(DamageType.Cold, 5),
