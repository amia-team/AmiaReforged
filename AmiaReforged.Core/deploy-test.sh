...
if [ ! -d "/home/amia/amia_server/test_server/anvil/Plugins/AmiaReforged.Core/" ]; then
    mkdir /home/amia/amia_server/test_server/anvil/Plugins/AmiaReforged.Core/
fi

dotnet publish AmiaReforged.Core --output /home/amia/amia_server/test_server/anvil/Plugins/AmiaReforged.Core/
