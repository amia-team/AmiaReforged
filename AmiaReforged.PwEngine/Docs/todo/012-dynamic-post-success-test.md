...
- [ ] A valid active template yields a persisted posting and a successful command result.
- [ ] The expected posted event and generic command-executed event are observable.
