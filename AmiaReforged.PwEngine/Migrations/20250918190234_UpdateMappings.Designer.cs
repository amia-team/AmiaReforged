...
namespace AmiaReforged.PwEngine.Migrations
{
    ...
    [Migration("20250918190234_UpdateMappings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AmiaReforged.PwEngine.Systems.WorldEngine.Characters.CharacterStatistics", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AmiaReforged.PwEngine.Systems.WorldEngine.Characters.CharacterStatistics", b =>
                {
                    b.HasOne("AmiaReforged.PwEngine.Database.Entities.PersistedCharacter", null)
                        .WithOne("Statistics")
                        .HasForeignKey("AmiaReforged.PwEngine.Systems.WorldEngine.Characters.CharacterStatistics", "CharacterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
