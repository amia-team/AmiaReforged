...
namespace AmiaReforged.PwEngine.Migrations
{
    ...
    [Migration("20260925191842_AddDynamicQuestPersistence")]
    partial class AddDynamicQuestPersistence
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AmiaReforged.PwEngine.Database.Entities.Economy.PersistentIndustryMembership", b =>
                {
                    ...
                    b.Property<int>("ProficiencyXp")
                        .HasColumnType("integer");

                    b.Property<int>("ProficiencyXpLevel")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AmiaReforged.PwEngine.Database.Entities.PersistedCodexNote", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("codex_notes", (string)null);
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Database.Entities.PersistedCodexQuest", b =>
                {
                    b.Property<Guid>("CharacterId")
                        .HasColumnType("uuid")
                        .HasColumnName("character_id");
                    ...
                    b.ToTable("codex_quests", (string)null);
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Database.Entities.PersistedDialogueTree", b =>
                {
                    ...
                    b.HasKey("DialogueTreeId")
                        .HasName("dialogue_trees_pkey");

                    b.HasIndex("SpeakerTag")
                        .HasDatabaseName("ix_dialogue_trees_speaker_tag");

                    b.ToTable("dialogue_trees", (string)null);
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Database.Entities.PersistedDynamicQuestCompletion", b =>
                {
                    b.Property<Guid>("CharacterId")
                        .HasColumnType("uuid")
                        .HasColumnName("character_id");
                    ...
                    b.HasKey("CharacterId", "TemplateId");

                    b.HasIndex("TemplateId");

                    b.ToTable("dynamic_quest_completions", (string)null);
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Database.Entities.PersistedDynamicQuestPosting", b =>
                {
                    ...
                    b.ToTable("dynamic_quest_postings", (string)null);
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Database.Entities.PersistedDynamicQuestTemplate", b =>
                {
                    b.Property<Guid>("TemplateId")
                        .HasColumnType("uuid")
                        .HasColumnName("template_id");
                    ...
                    b.ToTable("dynamic_quest_templates", (string)null);
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Database.Entities.PersistedLoreDefinition", b =>
                {
                    b.Property<string>("LoreId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                    ...
                    b.HasIndex("IsAlwaysAvailable")
                        .HasDatabaseName("codex_lore_definitions_always_available_idx");

                    b.HasIndex("Tier")
                        .HasDatabaseName("codex_lore_definitions_tier_idx");

                    b.ToTable("codex_lore_definitions", (string)null);
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Database.Entities.PersistedLoreUnlock", b =>
                {
                    b.Property<Guid>("CharacterId")
                        .HasColumnType("uuid")
                        .HasColumnName("character_id");
                    ...
                    b.ToTable("codex_lore_unlocks", (string)null);
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Database.Entities.PersistedQuestDefinition", b =>
                {
                    b.Property<string>("QuestId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<string>("CompletionRewardJson")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("CodexQuestDefinitions");
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Database.Entities.PersistedTraitDefinition", b =>
                {
                    b.Property<string>("Tag")
                        .HasMaxLength(50)
                    ...
                    b.Property<string>("AllowedClassesJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValue("[]")
                    ...
                    b.Property<string>("AllowedRacesJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValue("[]")
                    ...
                    b.Property<string>("ConflictingTraitsJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValue("[]")
                    ...
                    b.Property<string>("DeathBehavior")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                    ...
                    b.Property<string>("ForbiddenClassesJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValue("[]")
                    ...
                    b.Property<string>("ForbiddenRacesJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValue("[]")
                    ...
                    b.Property<string>("PrerequisiteTraitsJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValue("[]")
                    ...
                    b.Property<bool>("RequiresUnlock")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
            ...
            modelBuilder.Entity("AmiaReforged.PwEngine.Features.Encounters.Models.BossCondition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("BossConfigId")
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("BossConfigId")
                        .HasDatabaseName("IX_BossConditions_BossConfigId");

                    b.ToTable("BossConditions", (string)null);
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Features.Encounters.Models.BossConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("BossConfigs", (string)null);
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Features.Encounters.Models.GroupMutationOverride", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("MutationTemplateId")
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("SpawnGroupId", "MutationTemplateId")
                        .IsUnique()
                        .HasDatabaseName("IX_GroupMutationOverrides_Group_Mutation");

                    b.ToTable("GroupMutationOverrides", (string)null);
                });
            ...
            modelBuilder.Entity("AmiaReforged.PwEngine.Features.Encounters.Models.MutationEffect", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("MutationEffects", (string)null);
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Features.Encounters.Models.MutationTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("MutationTemplates", (string)null);
                });
            ...
            modelBuilder.Entity("AmiaReforged.PwEngine.Features.Encounters.Models.SpawnGroup", b =>
                {
                    ...
                    b.Property<bool>("OverrideMutations")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
            ...
            modelBuilder.Entity("AmiaReforged.PwEngine.Features.Encounters.Models.SpawnProfile", b =>
                {
                    ...
                    b.Property<int>("BossSpawnChancePercent")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
            ...
            modelBuilder.Entity("AmiaReforged.PwEngine.Features.Glyph.Persistence.GlyphDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("GlyphDefinitions", (string)null);
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Features.Glyph.Persistence.InteractionGlyphBinding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("GlyphDefinitionId")
                        .HasColumnType("uuid")
                        .HasColumnName("glyph_definition_id");

                    b.Property<string>("InteractionTag")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                    ...
                    b.HasIndex("GlyphDefinitionId");

                    b.HasIndex("InteractionTag");

                    b.HasIndex("InteractionTag", "GlyphDefinitionId", "AreaResRef")
                        .IsUnique();

                    b.ToTable("InteractionGlyphBindings", (string)null);
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Features.Glyph.Persistence.SpawnProfileGlyphBinding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SpawnProfileId", "GlyphDefinitionId")
                        .IsUnique()
                        .HasDatabaseName("IX_SpawnProfileGlyphBindings_Profile_Definition");

                    b.ToTable("SpawnProfileGlyphBindings", (string)null);
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Features.Glyph.Persistence.TraitGlyphBinding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TraitTag", "GlyphDefinitionId")
                        .IsUnique();

                    b.ToTable("TraitGlyphBindings", (string)null);
                });
            ...
            modelBuilder.Entity("AmiaReforged.PwEngine.Features.WorldEngine.Subsystems.Characters.CharacterData.KnowledgeProgression", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("AccumulatedProgressionPoints")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("accumulated_progression_points");

                    b.Property<string>("CapProfileTag")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                    ...
                    b.Property<int>("EconomyEarnedKnowledgePoints")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("economy_earned_knowledge_points");

                    b.Property<int>("LevelUpKnowledgePoints")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                    ...
                    b.ToTable("KnowledgeProgressions", (string)null);
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Features.WorldEngine.Subsystems.Industries.KnowledgeSubsystem.KnowledgeCapProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("KnowledgeCapProfiles", (string)null);
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Features.WorldEngine.Subsystems.Industries.Persistence.PersistedIndustryDefinition", b =>
                {
                    b.Property<string>("Tag")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                    ...
                    b.ToTable("IndustryDefinitions", (string)null);
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Features.WorldEngine.Subsystems.Industries.Persistence.PersistedRecipeTemplate", b =>
                {
                    b.Property<string>("Tag")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                    ...
                    b.Property<int?>("CraftingTimeRounds")
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("ProficiencyXpAwarded")
                        .HasColumnType("integer");

                    b.Property<int>("ProgressionPointsAwarded")
                        .HasColumnType("integer")
                        .HasColumnName("progression_points_awarded");

                    b.Property<string>("RequiredKnowledgeJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValue("[]")
                    ...
                    b.Property<string>("RequiredWorkstation")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                    ...
                    b.HasIndex("IndustryTag")
                        .HasDatabaseName("IX_RecipeTemplateDefinitions_IndustryTag");

                    b.HasIndex("Name")
                        .HasDatabaseName("IX_RecipeTemplateDefinitions_Name");

                    b.ToTable("RecipeTemplateDefinitions", (string)null);
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Features.WorldEngine.Subsystems.Industries.Persistence.PersistedWorkstationDefinition", b =>
                {
                    b.Property<string>("Tag")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                    ...
                    b.Property<string>("PlaceableResRef")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("placeable_resref");

                    b.Property<string>("SupportedIndustriesJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValue("[]")
                    ...
                    b.ToTable("WorkstationDefinitions", (string)null);
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Features.WorldEngine.Subsystems.Interactions.Persistence.PersistedInteractionDefinition", b =>
                {
                    b.Property<string>("Tag")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                    ...
                    b.Property<string>("AllowedAreaResRefsJson")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<int>("BaseRounds")
                        .HasColumnType("integer")
                    ...
                    b.Property<bool>("ProficiencyReducesRounds")
                        .HasColumnType("boolean")
                        .HasColumnName("proficiency_reduces_rounds");

                    b.Property<string>("RequiredIndustryTagsJson")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("RequiredKnowledgeTagsJson")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<bool>("RequiresIndustryMembership")
                        .HasColumnType("boolean")
                    ...
                    b.ToTable("InteractionDefinitions", (string)null);
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Features.WorldEngine.Subsystems.Items.Persistence.PersistedItemBlueprint", b =>
                {
                    b.Property<string>("ItemTag")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                    ...
                    b.Property<int>("WeightIncreaseConstant")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(-1)
            ...
            modelBuilder.Entity("AmiaReforged.PwEngine.Features.WorldEngine.Subsystems.Regions.Persistence.PersistedRegionDefinition", b =>
                {
                    b.Property<string>("Tag")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                    ...
                    b.Property<string>("DefaultChaosJson")
                        .HasColumnType("jsonb")
                    ...
                    b.ToTable("RegionDefinitions", (string)null);
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Features.WorldEngine.Subsystems.ResourceNodes.Persistence.PersistedResourceNodeDefinition", b =>
                {
                    b.Property<string>("Tag")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                    ...
                    b.Property<int>("BaseHarvestRounds")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                    ...
                    b.Property<string>("FloraPropertiesJson")
                        .HasColumnType("jsonb")
                    ...
                    b.Property<string>("TreePropertiesJson")
                        .HasColumnType("jsonb")
                    ...
                    b.ToTable("ResourceNodeDefinitions", (string)null);
                });
            ...
            modelBuilder.Entity("AmiaReforged.PwEngine.Database.Entities.PersistedDynamicQuestCompletion", b =>
                {
                    b.HasOne("AmiaReforged.PwEngine.Database.Entities.PersistedDynamicQuestTemplate", null)
                        .WithMany()
            ...
            modelBuilder.Entity("AmiaReforged.PwEngine.Database.Entities.PersistedLoreUnlock", b =>
                {
                    ...
                    b.HasOne("AmiaReforged.PwEngine.Database.Entities.PersistedLoreDefinition", "LoreDefinition")
                        .WithMany()
            ...
            modelBuilder.Entity("AmiaReforged.PwEngine.Features.Encounters.Models.BossCondition", b =>
                {
                    b.HasOne("AmiaReforged.PwEngine.Features.Encounters.Models.BossConfig", "BossConfig")
                        .WithMany("Conditions")
                        .HasForeignKey("BossConfigId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BossConfig");
                });

            modelBuilder.Entity("AmiaReforged.PwEngine.Features.Encounters.Models.BossConfig", b =>
                {
                    b.HasOne("AmiaReforged.PwEngine.Features.Encounters.Models.SpawnProfile", "SpawnProfile")
                        .WithMany("BossConfigs")
            ...
            modelBuilder.Entity("AmiaReforged.PwEngine.Features.Encounters.Models.GroupMutationOverride", b =>
                {
                    b.HasOne("AmiaReforged.PwEngine.Features.Encounters.Models.MutationTemplate", "MutationTemplate")
                        .WithMany()
                        .HasForeignKey("MutationTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AmiaReforged.PwEngine.Features.Encounters.Models.SpawnGroup", "SpawnGroup")
                        .WithMany("MutationOverrides")
                        .HasForeignKey("SpawnGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MutationTemplate");
            ...
            modelBuilder.Entity("AmiaReforged.PwEngine.Features.Glyph.Persistence.InteractionGlyphBinding", b =>
                {
                    b.HasOne("AmiaReforged.PwEngine.Features.Glyph.Persistence.GlyphDefinition", "GlyphDefinition")
                        .WithMany()
                        .HasForeignKey("GlyphDefinitionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GlyphDefinition");
                });
            ...
            modelBuilder.Entity("AmiaReforged.PwEngine.Features.Encounters.Models.SpawnGroup", b =>
                {
                    ...
                    b.Navigation("MutationOverrides");
                });
