...
public static class DamageProperties
{
    ...
    /// </summary>
    public static readonly IReadOnlyList<CraftingProperty> OneHanders = new[]
    {
        // +1 (minor)
    ...
    /// </summary>
    public static readonly IReadOnlyList<CraftingProperty> TwoHanders = new[]
    {
        // +1 (minor)
        new CraftingProperty
        {
    ...
    public static readonly IReadOnlyList<CraftingProperty> MassiveCriticals = new[]
    {
        new CraftingProperty
        {
            Cost = 1,
    ...
    /// </summary>
    public static readonly IReadOnlyList<CraftingProperty> Mighty = new[]
    {
        new CraftingProperty
        {
            Cost = 1,
    ...
    public static readonly IReadOnlyList<CraftingProperty> Ammo = new[]
    {
        // +1 (minor)
        new CraftingProperty
        {
