...
/// <summary>
///     Responsible for handling user input. It should ask any models (regular objects with state and logic) to update
///     their state, and then update the view.
///     Best practice is to keep the presenter as thin as possible, with the majority of the logic in the model. This
///     allows for easier debugging and testing.
///     The View is directly referenced by the Presenter, and the Presenter is directly referenced by the View. This is
///     allows for bidirectional communication between the two
