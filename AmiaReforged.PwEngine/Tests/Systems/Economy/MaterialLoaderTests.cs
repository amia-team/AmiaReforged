...
{
    private MaterialLoader _sut = null!;
    ...
    public void Should_Load_With_No_Errors()
    {
        ...
        Assert.Fail($"Failed to load some or all materials: some files had invalid parameters\n {failureString}");
    }
    ...
    public void Result_Should_Not_Be_Empty_Set()
    {
        ...
        Assert.That(_sut.LoadedResources, Is.Not.Empty, "Materials should have been loaded.");
    }
}
