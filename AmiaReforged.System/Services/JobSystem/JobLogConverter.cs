...
/// <summary>
///     Converts legacy job log data to the new system. It makes a guess at what the old data represents and converts it to
///     the new system.
/// </summary>
...
public class JobLogConverter
{
    ...
    public JobLogConverter()
    {
        ...
        Log.Info(message: "Job log converter initialized.");
    }
